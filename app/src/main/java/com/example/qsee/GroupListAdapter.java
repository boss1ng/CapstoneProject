...
public class GroupListAdapter extends RecyclerView.Adapter<GroupListAdapter.ViewHolder> {
        ...
        holder.editImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!group.getAdmin().equals(userId)) {
                    ...
                    Toast.makeText(v.getContext(), "Only the owner can edit the group.", Toast.LENGTH_LONG).show();
                } else {
        ...
        groupReference.child("admin").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (adminId != null && adminId.equals(userId)) {
                    ...
                    Toast.makeText(context, "Only the owner can delete the group.", Toast.LENGTH_LONG).show();
                }
            }
    ...
    private void deleteGroup(String groupName) {
        // Delete the group in Firebase
        DatabaseReference groupReference = databaseReference.child("Groups").child(groupName);
        DatabaseReference iconReference = databaseReference.child("Icons").child(groupName);
        iconReference.removeValue();
